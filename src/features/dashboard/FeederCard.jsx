...
import { Wifi, WifiOff, Settings, PawPrint, Wheat, Droplets, Fingerprint, Scale } from 'lucide-react';
import { getDeviceSensorData } from './deviceService';
import { queueCalibrateCommand, queueWaterCommand } from './commandService';
