...
const ScheduleModal = ({ isOpen, onClose, existingSchedule, devices }) => {
    ...
    const validate = () => {
        ...
        //find loops through an array and returns the first element that matches the condition. In this case, it finds the device with the selected deviceId.
            ...
            <div className="bg-background border border-border w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        ...
                        {errors.petId && !errors.deviceId && (
                            <div className="p-2 bg-amber-500/10 border border-amber-500/20 rounded-lg flex items-center gap-2 mt-1">
