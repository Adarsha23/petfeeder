...
import { Menu, User, Mail, Bell, LogOut, Save, CheckCircle2 } from 'lucide-react';
                    ...
                    <Card className="border-border shadow-sm">
                        ...
                        <CardContent className="space-y-6">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="font-bold text-lg text-foreground tracking-tight leading-none uppercase">
                    ...
                    <Card className="border-border shadow-sm">
                        ...
                        <CardContent className="space-y-1">
                            {[
                                ...
                                { label: 'Device Offline', desc: 'Notify if a feeder loses its heartbeat for over 5 minutes.' },
                            ].map((item, i) => (
