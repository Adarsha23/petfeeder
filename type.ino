...
// --- ☁️ SUPABASE CONFIG ---
// These are the API credentials for your specific Supabase project.
// In a production environment, you'd use SSL/HTTPS fingerprints for extra security.
...
void reportSensors() {
  ...
  // Send Telemetry
  Serial.println("\n--- 📊 SENDING TELEMETRY ---");
  Serial.print("⚖️ Tray: "); Serial.print(weight); Serial.println("g");
